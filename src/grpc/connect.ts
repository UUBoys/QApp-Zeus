...
export default (router: ConnectRouter) => {
    router.service(Zeus, {
        ...
        async createEstablishment({ name, description, street, city, country, image, ownerId }) {
            const establishment = await EstablishmentService.createEstablishment(ownerId, name, street, city, country, image, description);
        ...
        async createEvent({ name, description, establishmentId, date, price, maximumCapacity, image }) {
            const event = await EventService.createEvent(name, establishmentId, new Date(date), price, maximumCapacity, description, image);
